    ...
    $(listaDeProductos).each(function(){
        ...
        if(isTiendasRecomendadas !== -1){
            ...
            $(this).css({'background': '#448904',
                         'background': '-moz-linear-gradient(45deg, #448904 0%, #448904 30%, #b33409 70%, #b33409 100%)',
                         'background': ' -webkit-gradient(left bottom, right top, color-stop(0%, #448904), color-stop(30%, #448904), color-stop(70%, #b33409), color-stop(100%, #b33409))',
                         'background': ' -webkit-linear-gradient(45deg, #448904 0%, #448904 30%, #b33409 70%, #b33409 100%)',
                         'background': ' -o-linear-gradient(45deg, #448904 0%, #448904 30%, #b33409 70%, #b33409 100%)',
                         'background': ' -ms-linear-gradient(45deg, #448904 0%, #448904 30%, #b33409 70%, #b33409 100%)',
                         'background': ' linear-gradient(45deg, #448904 0%, #448904 30%, #b33409 70%, #b33409 100%)'});
